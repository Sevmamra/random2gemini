...
// Main initialization function to start the app after preloader is done
function init() {
...
function handleResize() {
  ...
  initHorizontalScroll(); // Re-initialize horizontal scroll on resize
}
...
function initDetailedAnimations() {
  ...
  // This requires CSS pseudo-element targeting, which is not directly possible with GSAP.
  // Assuming a wrapper with a border that can be animated.
  // For simplicity, we'll skip this part or assume the CSS handles it.
